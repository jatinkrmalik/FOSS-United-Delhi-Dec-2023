...
- **Job Security:** The more confusing your code, the more indispensable you become. `TribalKnowledge++`
...
In case you didn't get it, this talk was a **parody**.

^

Please:

- **Don't** write unmaintainable code.
- **Do** write code that is easy to understand and collaborate.
...
> The interesting aspect here is that despite this code being **highly unreadable** and **unusable** in a real-world scenario(for Humans), it is still syntactically correct and can be executed and in most cases will produce the expected output at near same performance as the optimised code. (Share an instance).

---

> So, if you are a **junior developer** and you are struggling to understand the code written by your **senior developer**, it's not your fault but you 
should use this as an opportunity to learn and improve your skills and don't be shy to supplement your knowledge using AI tools like **Github Copilot**.

> Don't be naive to stick to the **old ways** of doing things, **embrace** the **new** and **improve** your **productivity**.

---

-> # Thank You! <-

All the code used in this presentation will be available on Github. I will share the repo link shortly on Twitter. 
